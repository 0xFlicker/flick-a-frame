...
export type _TokenWhitelist_orderBy =
  ...
  /** null **/
  tokenWhitelistSymbol: InContextSdkMethod<Query['tokenWhitelistSymbol'], QuerytokenWhitelistSymbolArgs, MeshContext>,
  /** null **/
  tokenWhitelistSymbols: InContextSdkMethod<Query['tokenWhitelistSymbols'], QuerytokenWhitelistSymbolsArgs, MeshContext>,
  /** null **/
  ...
  /** null **/
  tokenWhitelistSymbol: InContextSdkMethod<Subscription['tokenWhitelistSymbol'], SubscriptiontokenWhitelistSymbolArgs, MeshContext>,
  /** null **/
  tokenWhitelistSymbols: InContextSdkMethod<Subscription['tokenWhitelistSymbols'], SubscriptiontokenWhitelistSymbolsArgs, MeshContext>,
  /** null **/
  ...
  export type Context = {
      ["uniswap-v3-base"]: { Query: QuerySdk, Mutation: MutationSdk, Subscription: SubscriptionSdk },
